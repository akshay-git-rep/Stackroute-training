...
class LaptopSerializer(serializers.Serializer):
    """Serializes model and price fields for LaptopAPIView"""
    modelname = serializers.CharField(max_length=20)
...
class LaptopModelSerializer(serializers.ModelSerializer):
    """Serializes model and other laptop fields for LaptopAPIView"""
    class Meta:
        model = models.Laptop
